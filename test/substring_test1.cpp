...
BOOST_AUTO_TEST_CASE( test_main )
{
    ...
    using std::string;
    typedef typename string::const_iterator string_const_iterator;
    typedef std::pair<string_const_iterator, string_const_iterator> sres;

    using std::wstring;
    typedef typename wstring::const_iterator wstring_const_iterator;
    typedef std::pair<wstring_const_iterator, wstring_const_iterator> wsres;
    ...
    string str1 = "abcdef";
    res estr1 = make_pair(str1.begin(), str1.end());
    string str2 = "All human beings are born free and equal in dignity and rights.";
    res estr2 = make_pair(str2.begin() + 9, str2.begin() + 9 + 5); // " bein"
    wstring wstr1 = L"abcdef";
    res ewstr1 = make_pair(wstr1.begin(), wstr1.end());
